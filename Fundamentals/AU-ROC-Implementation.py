...
Problem statement
===================
Given a dataframe consisting of predicted probabilities and true labels of the observations, return the AU-ROC rounded
off to two decimal places after implementing AU-ROC from scratch.
